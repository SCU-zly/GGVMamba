...
from dataset_boneAge import build_BAA_dataset_train
# from engine import train_one_epoch, evaluate
from engine_for_BAA import train_one_epoch, evaluate
...
import boneAge.Mamba_series.Vim.vim.models_Vim as models_Vim
#data augmentation
...
def get_args_parser():
    ...
    #add
    parser.add_argument('--img_transform', default=None,
                        help='img_transform way')
    parser.add_argument('--dataset', default='RHPE',
                        help='dataset to load')
    parser.add_argument('--use_relative_age', type=str, default=True)
    return parser
...
def main(args):
    ...
    transform_train = Compose([
        ...
        RandomResizedCrop(args.input_size, args.input_size,
                          (0.5, 1.0), p = 0.5),
    ...
    args.img_transform = transform_train
    dataset_train = build_BAA_dataset_train(is_train=True, args=args)
    if args.disable_eval_during_finetuning:
        dataset_val = None
    else:
        args.img_transform = transform_val
        dataset_val = build_BAA_dataset_train(is_train=False, args=args)
